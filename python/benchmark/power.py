...
class N6705C:
    ...
    def ch0_measure(self, interval=0.001, mtime=10, curr_range=0.001, volr_range=5):
        ...
        # print("Measure samples set to "+self.instrument.query("SENS:SWE:POIN? (@2)"))
        self.instrument.write("SENS:CURR:RANG "+ str(curr_range)+", (@2)")
        # print("Measure current range set to "+self.instrument.query("SENS:CURR:RANG? (@2)"))
        self.instrument.write("SENS:VOLT:RANG "+ str(volr_range)+", (@2)")
        # print("Measure voltage range set to "+self.instrument.query("SENS:VOLT:RANG? (@2)"))
