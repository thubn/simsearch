...
class OptimizedEmbeddingSearchUint8AVX2
    : public OptimizedEmbeddingSearchBase<avx2i_vector, uint32_t, __m256i> {
public:
...
private:
  uint32_t cosine_similarity_optimized(const __m256i *vec_a, const __m256i *vec_b) const override;
