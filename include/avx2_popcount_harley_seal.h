...
namespace AVX2_harley_seal
{
    ...
    inline __m256i popcount(const __m256i v)
    {
    ...
    inline uint64_t popcnt(const __m256i *data, const uint64_t size)
    {
        ...
        return static_cast<uint64_t>(_mm256_extract_epi64(total, 0)) + static_cast<uint64_t>(_mm256_extract_epi64(total, 1)) + static_cast<uint64_t>(_mm256_extract_epi64(total, 2)) + static_cast<uint64_t>(_mm256_extract_epi64(total, 3));
    }

} // AVX2_harley_seal

class AVX2PopcountHarleySeal
{
private:
