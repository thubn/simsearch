...
namespace config
{
    ...
    struct AlgorithmConfig
    {
        ...
        nlohmann::json toJson() const
        {
            return {
                {"k", k},
                {"rescoringFactor", rescoringFactor}};
        }
    ...
    struct MemoryConfig
    {
        ...
        static MemoryConfig fromJson(const nlohmann::json &j)
        {
            ...
            config.prefetchDistance = j.value("prefetchDistance", config.prefetchDistance);
            return config;
        }
    };
    ...
    struct SearchConfig
    {
        ...
        static SearchConfig fromFile(const std::string &filename)
        {
            ...
            {
                throw ConfigException(
                    ConfigException::ErrorCode::FileNotFound,
            ...
            {
                throw ConfigException(
                    ConfigException::ErrorCode::ParseError,
